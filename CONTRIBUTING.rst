...
freckles could always use more documentation, whether as part of the
official freckles docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
2. Use *freckles* to check out the forked repo and setup everything necessary:

.. code:: console

   curl https://freckles.io | bash -s -- freckles gh:<your_github_username>/freckles
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/makkus/freckles/pull_requests
