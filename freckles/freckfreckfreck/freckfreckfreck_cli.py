...
def load_plugins():
    ...
    mgr = ExtensionManager(
        namespace="freckfreckfreck.plugins",
...
class FreckFreckFreckCommand(FrecklesBaseCommand):
    def __init__(self, *args, **kwargs):
        super(FreckFreckFreckCommand, self).__init__(**kwargs)
...
@click.command(
    name="freckfreckfreck",
    cls=FreckFreckFreckCommand,
