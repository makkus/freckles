...
from freckles.frecklet.arguments import RequiredVariablesAttribute, CliArgumentsAttribute
from freckles.frecklet.tasks import FreckletsAttribute, TaskListDetailedAttribute, TaskTreeAttribute, TaskListAttribute, \
...
class FreckletCast(TingCast):
    ...
    FRECKLET_ATTRS = [
        ...
        ArgsAttribute(source_attr_name="_metadata_raw", target_attr_name="args", index_attr_name="_meta_parent_repo", validate_list_attr="template_keys"),
        DocAttribute(),
        FreckletMetaAttribute(),
        FreckletsAttribute(),
        TaskListDetailedAttribute(),
